...
def chat():
    ...
    opciones = {
        ...
        "4": "🛒 Venta de equipo minisplit: contamos con equipo BAIR 1 tonelada 110V frío/calor nuevo $6,500 MXN (precio con instalación BASICA). Pregunta también por nuestros equipos usados en venta.",
        "venta de equipo": "🛒 Venta de equipo minisplit: contamos con equipo BAIR 1 tonelada 110V frío/calor nuevo $6,500 MXN (precio con instalación). Pregunta también por nuestros equipos usados en venta.",
        "venta de equipo minisplit": "🛒 Venta de equipo minisplit: contamos con equipo BAIR 1 tonelada 110V frío/calor nuevo $6,500 MXN (precio con instalación). Pregunta también por nuestros equipos usados en venta.",
